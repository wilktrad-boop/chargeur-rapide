...
export default function BatteriesIndex() {
  const posts = getCategoryPosts('batteries');
  return (
    <>
      <Header />
      <main className="mx-auto max-w-6xl px-4">
        <div className="my-8">
          <h1 className="text-3xl font-semibold text-textStrong">Batteries</h1>
          <p className="mt-2 text-slate-700">Batteries externes, stations portables, solaire pliable.</p>
        </div>
