...
export function StickyCTA({ label, url, note }: Props) {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 bg-primary shadow-[0_-4px_24px_rgba(14,165,233,0.35)]">
      <div className="mx-auto max-w-6xl px-4 py-3 flex items-center justify-between gap-4">
        {note && (
          <p className="text-sm text-white/80 hidden sm:block truncate">{note}</p>
        )}
